...
import test.java.utils.PropertyUtils;

public class LTCCustomizedReporter extends TestListenerAdapter implements IReporter
{
        ...
        Throwable exception, ITestNGMethod method, String nodeIp, ITestResult result) throws IOException
{
	...
	System.out.println("Inside generateStackTraceReport..");
...
private void generateTestExecutionStatus(List<ISuite> suites)
{
	...
	System.out.println("Inside generateTestExecutionStatus..");
    String testName = "";
        ...
        String newFileName) throws Exception
{
	...
	System.out.println("Inside generateModuleOverallTestReport..");
        ...
        String passedModule, String nodeIp) throws IOException
{
	...
	System.out.println("Inside generateModuleWiseTestReport..");
	final PrintWriter pw = new PrintWriter(new BufferedWriter(new FileWriter(new File(outputDir, newFileName))));
        ...
        String fileName, ArrayList<ITestNGMethod> testngMethods, String nodeIp) throws IOException
{
	...
	System.out.println("Inside generateModuleTestMethodSummary..");
...
{
	System.out.println("Inside generateExceptionReport..");
    pw.flush();
...
{
	System.out.println("Inside generateExceptionReport-overloaded method..");
...
{
	System.out.println("Inside createWriter..");
...
private void startHtmlPage(PrintWriter out)
{
	...
	System.out.println("Inside startHtmlPage..");
...
{
	System.out.println("Inside endHtmlPage..");
        ...
        String passPercentage)
{
	...
	System.out.println("Inside generateModulesRow..");
    String passCount = "";
    String failCount = "";
    String skipCount = "";
...
private void generateAdditionalInfoReport(List<ISuite> suites) throws Exception
{
	...
	System.out.println("Inside generateAdditionalInfoReport..");
